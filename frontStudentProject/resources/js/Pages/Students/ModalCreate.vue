...
<template>
    <BreezeButton @click="obj.open = !obj.open">Crear estudiante</BreezeButton>
    <Modal :open="obj.open" @close="obj.open = false">
        <template #icon>
        ...
        <template #title>Crear estudiante</template>
        <template #content>
